...
pub(crate) use crate::params::{N, Q, D, ETA, K, L, LEN_ETA_PACK_POLY, LEN_PRIVATE_KEY, LEN_PUBLIC_KEY, LEN_T0_PACK_POLY};
use getrandom;
...
pub(crate) fn key_gen_internal(xi: &[u8; 32]) -> ([u8; LEN_PUBLIC_KEY], [u8; LEN_PRIVATE_KEY]) {
    let mut rho = [0u8; 32];
